...
try {
  ...
  const expected = ['carve_apply_ast_patch', 'carve_apply_reversible_ast_patch', 'carve_create_ast_patch', 'carve_create_reversible_ast_patch', 'carve_format', 'carve_lint', 'carve_migrate', 'carve_parse', 'carve_render'];
