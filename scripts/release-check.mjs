...
try {
  ...
  for (const required of ['carve_lint', 'carve_format', 'carve_render', 'carve_parse', 'carve_create_ast_patch', 'carve_apply_ast_patch', 'carve_select_ast_nodes', 'carve_create_reversible_ast_patch', 'carve_apply_reversible_ast_patch', 'carve_migrate']) {
