...
const calls = [
  ...
  ['carve_plan_ast_edit', { source: '# A\n\n# B', selector: { kind: 'heading-id', value: 'B' }, edit: { kind: 'rename-heading-id', id: 'A' }, then: [{ selector: { kind: 'heading-id', value: 'A' }, edit: { kind: 'rename-heading-id', id: 'C' } }] }],
  ['carve_plan_ast_edit', { source: '{#same}\n# A\n\n{#same}\n# B\n\nBody', selector: { kind: 'node-type', value: 'paragraph' }, edit: { kind: 'replace-text', text: 'Updated' } }],
  ['carve_plan_ast_edit', { source: 'One\n\nTwo\n\nThree', selector: { kind: 'ast-path', value: '/children/0' }, edit: { kind: 'delete-node' }, then: [{ selector: { kind: 'ast-path', value: '/children/2' }, edit: { kind: 'delete-node' } }] }],
  ['carve_plan_ast_edit', { source: '# A', selector: { kind: 'heading-id', value: 'A' }, edit: { kind: 'replace-text', text: 'B' }, then: [{ selector: { kind: 'ast-path', value: '/children/0/children/0' }, edit: { kind: 'delete-node' } }] }],
  ['carve_plan_ast_edit', { source: 'Text[^a]\n\n[^a]: Note\n', selector: { kind: 'ast-path', value: '/children/0' }, edit: { kind: 'replace-node', node: { type: 'paragraph', children: [{ type: 'text', value: 'Text' }] } }, then: [{ selector: { kind: 'footnote-label', value: 'a' }, edit: { kind: 'delete-node' } }] }],
